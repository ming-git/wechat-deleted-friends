...
# TODO PY3: not supported in Python3?
# Error:(9, 8) No module named urllib2
import urllib2
import re

# TODO PY3: not supported in Python3
# Error:(13, 8) No module named cookielib
import cookielib
import time
...
def getuuid():
    ...
    # Warning:(56, 52) Cannot find reference 'urlencode' in '__init__.py'
...
def showqrimage():
    ...
    # Warning:(84, 52) Cannot find reference 'urlencode' in '__init__.py'
    request = urllib2.Request( url=url, data=urllib.urlencode( params ) )
    response = urllib2.urlopen( request )
...
def webwxgetcontact():
    ...
    for i in range( len( MemberList ) - 1, -1, -1 ):
        ...
        if member['VerifyFlag'] & 8 != 0:  # 公众号/服务号
            ...
            MemberList.remove( member )
        # Warning:(252, 39) Expected type 'Integral', got 'str' instead
...
if __name__ == '__main__':
    ...
    # Update History
    # 2016-1-6 13:43 1. update raw_input() to input()
    # 2016-1-6 13:43 2. update print '' to print('...')
    # 2016-1-6 13:47 3. Variable Upper cast to lowercase
    # 2016-1-6 13:49 4. xrange() to range()
    # 2016-1-6 15:30 5. 函数名小写
